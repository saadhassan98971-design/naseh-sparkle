    ...
    <section id="blogs" className="py-24 md:py-32 bg-surface">
      <div className="container-page">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {POSTS.map((p) => (
            <a key={p.title} href="#" className="group block rounded-3xl bg-card border border-border p-8 shadow-soft hover:shadow-elegant hover:-translate-y-1 transition-all">
