      ...
      <div className="container-page">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {ITEMS.map((it) => (
            <article
              key={it.title}
              className="group flex flex-col rounded-3xl overflow-hidden bg-card border border-border shadow-soft hover:shadow-elegant hover:-translate-y-1 transition-all"
            >
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <a href="#" className="mt-4 inline-flex items-center gap-1.5 text-sm font-medium text-gold-foreground story-link self-start" style={{ color: "var(--terracotta)" }}>
