      ...
      <div className="container-page grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
        ...
        <div>
          ...
          <h2 className="mt-3 font-display text-4xl md:text-5xl font-semibold text-primary text-balance">
            A community rooted in <em className="not-italic text-primary/80">character</em>, driven by <em className="not-italic text-primary/80">curiosity</em>.
          </h2>
          ...
          <div className="mt-8 space-y-4">
            {FEATURES.map(({ icon: Icon, title, text }) => (
              <div
                key={title}
                className="group flex gap-4 p-5 rounded-2xl border border-border bg-card hover:shadow-soft hover:-translate-y-0.5 transition-all"
              >
