        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {CLASSES.map((c, i) => (
            <Reveal key={c.title} delay={i * 140}>
              <div className="card-glow group rounded-3xl overflow-hidden bg-card border border-border shadow-soft hover:shadow-elegant hover:-translate-y-1 transition-all h-full">
